...
![Stars](https://img.shields.io/github/stars/ayinedjimi/AmcacheForensics?style=social) ![Forks](https://img.shields.io/github/forks/ayinedjimi/AmcacheForensics?style=social) ![Issues](https://img.shields.io/github/issues/ayinedjimi/AmcacheForensics)
...
**🚀 AmcacheForensics - Analyseur Forensique de l'Amcache Windows** est un projet développé par **Ayi NEDJIMI Consultants**, expert en cybersécurité et intelligence artificielle.
...
```bash
git clone https://github.com/VOTRE_USERNAME/AmcacheForensics.git
cd AmcacheForensics
```
